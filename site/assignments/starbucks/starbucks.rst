...
* **Worth**: 5%
* **DUE**: Monday September 28, 2026 at 11:55pm; submitted on MOODLE.
...
Humans like to express `latitudes <https://en.wikipedia.org/wiki/Latitude>`_ and
`longitudes <https://en.wikipedia.org/wiki/Longitude>`_ in degrees, minutes, and seconds. You *could* work with those
